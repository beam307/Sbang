						...
						<div class="card wizard-card" data-color="red" id="wizardProfile">
							<form class="form-horizontal" id="registerForm" method="post">
								<div class="wizard-navigation">
									<ul>
										<li><a href="#about" data-toggle="tab">공지사항 등록</a></li>
									</ul>
								</div>
										...
										<div class="">
											<div class="form-horizontal">
												<div class="form-group label-floating">
													<div class="col-sm-12">
														<label class="control-label">공지사항 제목</label> <input type="text" class="form-control" name="noticeTitle" id="noticeTitle" value="${noticeVO.noticeTitle }">
													</div>
												</div>
											</div>
										</div>
