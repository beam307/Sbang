...
<div class="onenone container inner">
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">

		<div class="panel panel-default">
			<div class="panel-heading" role="tab" id="heading1">
				<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"> 제목 </a>
				</h4>
			</div>
			<div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1">
				<div class="panel-body">
					...
					<div class="table-responsive reply m_t_20">
						<table class="table">
							<!-- On rows -->
							<tr class="reply-tit"></tr>

							<!-- On cells (`td` or `th`) -->
							<tr>
								<td class="col-xs-10">답글내용</td>
							</tr>
						</table>
					</div>
				</div>
