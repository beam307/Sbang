			...
			<div class="panel panel-default">
				...
				<div id="collapse${status.index + 1 }" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading${status.index + 1 }">
					<div class="panel-body">
						<!--<textarea readonly="readonly" style="cursor: default; min-height: 150px; min-width: 1100px;" class="form-control " name="studyIntroduce" id="studyIntroduce">${qnAVO.qnAContent }</textarea>  -->
						<!-- <div class="table-responsive reply m_t_20">
						</div> -->
						<div class="panel-body">${qnAVO.qnAContent }</div>
					</div>
				</div>
			</div>
		</c:forEach>
