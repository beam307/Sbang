	...
	<div class="userInfo">
		<div class="">
			<div class="card hovercard">
				...
				<div class="card-info">
					<span class="card-title">${userVO.userNick }</span>
				</div>
			</div>
			...
			<div class="well">
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab1">
						<div class="row">
							<div class="col-xs-3 user-info-tit">가입일</div>
							...
							<div class="col-xs-3 user-info-tit">성별</div>
							<div class="col-xs-9 user-info-con">
							...
							<div class="col-xs-3 user-info-tit">나이</div>
							<div class="col-xs-9 user-info-con">
								<small><i class="fa fa-angle-right" aria-hidden="true"></i> </small>
								<!-- 생년월일을 나이로  -->
								...
								<c:set var="userBirth">
									<fmt:formatNumber value="${userVO.userBirth}" />
								</c:set>
							...
							<div class="col-xs-3 user-info-tit last">자기소개</div>
					...
					<div class="tab-pane fade in" id="tab2">
						<div class="row">
							<div class="col-xs-3 user-info-tit">참여횟수</div>
							<div class="col-xs-9 user-info-con">
								<small><i class="fa fa-angle-right" aria-hidden="true"></i> </small> ${applyStudyCnt }
							</div>

							<div class="col-xs-3 user-info-tit">관심 카테고리</div>
							...
							<div class="col-xs-3 user-info-tit">관심 지역</div>
							<div class="col-xs-9 user-info-con">
								<small><i class="fa fa-angle-right" aria-hidden="true"></i> </small>
							...
							<div class="col-xs-3 user-info-tit">참여중</div>
								...
								<div class="studyList">
									<c:if test="${fn:length(applyStudyList) >= 1 }">
										<c:forEach items="${applyStudyList}" varStatus="listIdx" var="studyVO">
											<a class="studyName_link" data-studyNo="${studyVO.studyNo}" style="cursor: pointer">${listIdx.index+1 } | ${studyVO.studyName }</a>
											<br>
										</c:forEach>
									</c:if>
							...
							<div class="col-xs-3 user-info-tit last">히스토리</div>
							<div class="col-xs-9 user-info-con last">
								<div class="sm">
									<small><i class="fa fa-angle-right" aria-hidden="true"></i> </small>
								</div>
								<div class="studyList">
									<c:if test="${fn:length(endStudyList) >= 1 }">
										<c:forEach items="${endStudyList}" varStatus="listIdx" var="studyVO">
											<a class="endStudyName_link" data-studyNo="${studyVO.studyNo}" style="cursor: pointer">${listIdx.index+1 } | ${studyVO.studyName }</a>
											<br>
										</c:forEach>
									</c:if>
...
<script type="text/javascript" src="/resources/dist/js/user/userInfo.js"></script>
</body>
</html>