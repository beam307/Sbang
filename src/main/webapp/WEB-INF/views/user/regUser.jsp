	...
	<div class="join animate" data-animate="fadeInUp" data-duration="1.0s" data-delay="0.1s">
		<form action="/user/regUser" method="post" id="joinForm">
			<div class="form-group label-floating">
				<a href="/login/kakao" class="kakao-login"> <img src="/resources/images/kakao-icon.jpg" alt=""> 카카오계정으로로그인</a>
				<a href="/login/naverLogin" class="naver-login"> <img src="/resources/images/naver-icon.jpg" alt=""> 네이버계정으로로그인</a>
			</div>
