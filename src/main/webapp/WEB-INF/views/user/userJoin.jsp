...
<div class="join container inner">
	<form action="/user/regUser" method="post">
	    <div class="form-group">
	        ...
	        <input name="userName" type="text" class="form-control" id="InputName" placeholder="실명을 입력하세요">
	    </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
	        ...
	        <input name="userPwd" type="password" class="form-control" id="InputPassword" placeholder="비밀번호를 입력하세요">
	    </div>
	    <div class="form-group">
	        <label for="InputBirthday">생년월일</label>
	        <input name="userBirth" type="text" class="form-control" id="InputBirthday" placeholder="ex.990101">
	    </div>
	    <div class="form-group">
