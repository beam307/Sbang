<div class="col-sm-11">
	<div class="col-sm-4 form-group">
		<select id="upRegion" name="userFavUpRegion" class="form-control filtering">
	...
	<div class="col-sm-7 form-group">
		<select id="downRegion" name="userFavDownRegion" class="form-control filtering">
		</select>
	</div>
</div>
<script type="text/javascript" src="/resources/dist/js/regionCategory.js"></script>