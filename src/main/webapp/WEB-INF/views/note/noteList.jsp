								...
								<div class="panel panel-default">
									<div class="panel-heading" role="tab" id="heading${listIdx.index }">
										<h4 class="panel-title">
											...
											<a href="#" data-cut='${noteVO.noteSender }' data-nick='${noteVO.userNick }' class="btn btn-danger cutOff-btn">차단</a>
											<input type="button" class="btn btn-danger answear-btn" data-target='${noteVO.noteSender }' value="답장" />
											<small>
												<a href='#' data-no='${noteVO.noteSender }' class="userNick_link">${noteVO.userNick } </a>
