...
<div class="container main-thumbnail">
	<h1>
		NEW STUDY <a href="/study/studyList" class="more">더보기</a>
	</h1>
	<h2 class="line"></h2>
...
<div class="container main-thumbnail">
	<h1>
		BEST STUDY <a href="/study/studyList?lineUp=f" class="more">더보기</a>
	</h1>
	<h2 class="line"></h2>
	<div class="study-thumbnail">
...
<div class="container main-thumbnail recommend">
	<h1>
		RECOMMENDING STUDY <a href="/study/studyList" class="more">더보기</a>
	</h1>
	<h2 class="line"></h2>
