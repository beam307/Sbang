										...
										<div class="box list collapse" id="CA01">
											<div class="content1">
												...
												<input id="CA01_00" type="checkbox" name="studyCategory" value="중국어" /> <label class="midCategoryBox" for="CA01_00"># 중국어</label> <input
													id="CA01_01" type="checkbox" name="studyCategory" value="일본어" /> <label class="midCategoryBox" for="CA01_01"># 일본어</label> <input
													id="CA01_02" type="checkbox" name="studyCategory" value="독일어" /> <label class="midCategoryBox" for="CA01_02"># 독일어</label> <input
													id="CA01_03" type="checkbox" name="studyCategory" value="아랍어" /> <label class="midCategoryBox" for="CA01_03"># 아랍어</label> <input
													id="CA01_07" type="checkbox" name="studyCategory" value="프랑스어" /> <label class="midCategoryBox" for="CA01_07"># 프랑스어</label> <input
													id="CA01_05" type="checkbox" name="studyCategory" value="스페인어" /> <label class="midCategoryBox" for="CA01_05"># 스페인어</label> <input
													id="CA01_06" type="checkbox" name="studyCategory" value="러시아어" /> <label class="midCategoryBox" for="CA01_06"># 러시아어</label> <input
													id="CA01_08" type="checkbox" name="studyCategory" value="베트남어" /> <label class="midCategoryBox" for="CA01_08"># 베트남어</label> <input
													id="CA01_04" type="checkbox" name="studyCategory" value="태국어" /> <label class="midCategoryBox" for="CA01_04"># 태국어</label> <input
													id="CA01_09" type="checkbox" name="studyCategory" value="외국어기타" /> <label class="midCategoryBox" for="CA01_09"># 외국어 기타</label>
										...
										<div class="box list collapse" id="CA02">
											<div class="content2">
												...
												<input id="CA02_00" type="checkbox" name="studyCategory" value="응용프로그래밍" /> <label class="midCategoryBox" for="CA02_00">#
													...
													모바일프로그래밍</label> <input id="CA02_03" type="checkbox" name="studyCategory" value="데이터베이스/서버" /> <label class="midCategoryBox" for="CA02_03">#
													데이터베이스/서버</label> <input id="CA02_04" type="checkbox" name="studyCategory" value="게임프로그래밍" /> <label class="midCategoryBox" for="CA02_04">#
													게임프로그래밍</label> <input id="CA02_05" type="checkbox" name="studyCategory" value="문서작성/편집" /> <label class="midCategoryBox" for="CA02_05">#
													문서작성/편집</label> <input id="CA02_06" type="checkbox" name="studyCategory" value="컴퓨터자격증" /> <label class="midCategoryBox" for="CA02_06">#
													컴퓨터자격증</label> <input id="CA02_07" type="checkbox" name="studyCategory" value="사물인터넷" /> <label class="midCategoryBox" for="CA02_07">#
													사물인터넷</label> <input id="CA02_08" type="checkbox" name="studyCategory" value="하드웨어" /> <label class="midCategoryBox" for="CA02_08">#
													하드웨어</label> <input id="CA02_09" type="checkbox" name="studyCategory" value="컴퓨터기타" /> <label class="midCategoryBox" for="CA02_09">#
													컴퓨터 기타</label>
										...
										<div class="box list collapse" id="CA06">
											<div class="content6">
												...
												<input id="CA06_00" type="checkbox" name="studyCategory" value="기타/우쿠렐라" /> <label class="midCategoryBox" for="CA06_00">#
													...
													밴드</label> <input id="CA06_05" type="checkbox" name="studyCategory" value="국악" /> <label class="midCategoryBox" for="CA06_05"># 국악</label>



												<input id="CA06_06" type="checkbox" name="studyCategory" value="연기/연극/뮤지컬" /> <label class="midCategoryBox" for="CA06_06">#
										...
										<div class="box list collapse" id="CA07">
											<div class="content7">
												...
												<input id="CA07_00" type="checkbox" name="studyCategory" value="축구" /> <label class="midCategoryBox" for="CA07_00"># 축구</label> <input
													...
													id="CA07_09" type="checkbox" name="studyCategory" value="스케이트/보드" /> <label class="midCategoryBox" for="CA07_09"># 스케이트/보드</label>



												<input id="CA07_10" type="checkbox" name="studyCategory" value="요가/에어로빅" /> <label class="midCategoryBox" for="CA07_10">#
		...
		<div class="step2">
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="col-sm-12">
							<input type="text" class="form-control" name="studyMaxMemCnt" id="studyMaxMemCnt" placeholder="ex.10명">
						</div>
					</div>
				</div>
				<div class="col-sm-12">
		...
		<div class="step3">
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="col-sm-12">
							<textarea class="form-control" rows="10" name="studyIntroduce" id="studyIntroduce"></textarea>
						</div>
					</div>
				</div>
				<div class="form-group">
