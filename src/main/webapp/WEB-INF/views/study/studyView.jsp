...
<div class="container view inner">
	...
	<div class="row">
		<div class="col-xs-12 view-tit">
			<h1>
				스터디제목 <span class="view-category">영어</span><span class="view-category">it</span>
			</h1>
		</div>
		<div class="col-xs-12 view-user">
			<div class="user-img col-xs-1">
		...
		<div class="col-xs-12 view-info">
			...
			<div class="col-md-1">소개글</div>
			<div class="col-md-11">
				안녕하세요 스방이예요 <br /> 스프링 스터디 하실분 구해요
			</div>

			<a href="" class="view-btn">수정</a> <a href="" class="view-btn">삭제</a>
